                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          <div class="form-group">
                            <textarea class="form-control" name="message" placeholder="write.."><?php echo $edit_events['message']; ?></textarea>
                          </div>
                          <div class="form-group">
                            <input class="form-control" type="text" name="topic" value="<?php echo $edit_events['topic']; ?>" placeholder="Topic">
                          </div>
                          <div class="form-group">
                            <h5>POST EVENT IMAGES HERE</h5>
                              <input type="file" name="fileToUpload">
                            </div>

                            <button type="submit" class="btn btn-success" href='<?php echo $edit_teams['id']; ?>'></a>Update</button>
