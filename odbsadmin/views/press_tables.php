      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <?php foreach ($press_releases as $press_release): $id = $press_release['id']; $images = $press_release['images']; $date = date('d-m-Y'); ?>
                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="topic" value="<?php echo $press_release['topic']; ?>" placeholder="Topic">
                          </div>

                            <div class="form-group">
                              <h2>Admin</h2>
                              <input class="form-control" type="text" name="admin" value="<?php echo $press_release['admin']; ?>" placeholder="Admin">
                            </div>

                           <div class="form-group">
                            <h2>Message</h2>
                            <textarea class="form-control" name="message" placeholder="write.."><?php echo $press_release['message']; ?></textarea>
                          </div>
                      ...
                      <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                        <div class="innercolumn">
                          <div class="form-group">
                            ...
                            <?php echo "<td><img style='width: 70px; height: 70px; margin-bottom: 50px;' src='../".$images."' alt='images'></td>";  ?><br>
                            <?php echo "<td><a href='edit_press?id={$id}'>EDIT PRESS</a></td>"; ?><br>
                            <?php echo "<td><a href='view_press?id={$id}'>VIEW PRESS</a>"; ?><br>
                            <?php echo "<td><a href='delete_press?id={$id}'>DELETE PRESS</a><td>"; ?><br>
                            <span>Date:</span>  <td><?php echo $date ?></td><br>

                            <a href="nurseryname" class="btn btn-primary" type="submit">Back To Dashboard</a>
