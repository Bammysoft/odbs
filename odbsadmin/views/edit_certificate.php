    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><h2> CERTIFICATE(S)</h2></li>
        </ol>
                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          <div class="form-group">
                            <h5>POST CERTIFICATE </h5>
                              <input type="file" name="fileToUpload">
                            </div>
                          <div class="form-group">
                            <input class="form-control" type="text" name="fulname" value="<?php echo $edit_certificates['fulname']; ?>" placeholder="Topic">
                          </div>
                          
                            <button type="submit" class="btn btn-success" href='<?php echo $edit_certificates['id']; ?>'></a>Update</button>
                            <a href="certificate_tables" class="btn btn-primary" type="submit">Back To Dashboard</a>
                          </div>
                        </div>
                      </div>
                  </form>
