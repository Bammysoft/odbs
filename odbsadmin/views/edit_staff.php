                    ...
                    <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                      ...
                      <div class="contactform">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <h3>Firstname</h3>
                            <input class="form-control" type="text" name="firstname" value="<?php echo $edit_staffs['firstname']; ?>" placeholder="Firstname">
                          </div>
                            ...
                            <div class="form-group">
                              <h3>Facebook Link</h3>
                              <input class="form-control" type="text" name="face" value="<?php echo $edit_staffs['face']; ?>"  placeholder="Facebook">
                            </div>

                            <div class="form-group">
                               <h3>Tweeter Link</h3>
                              <input class="form-control" type="text" name="tweet" value="<?php echo $edit_staffs['tweet']; ?>" placeholder="Tweeter">
                            </div>
                            <div class="form-group">
                              <h3>Bank Name</h3>
                              <input class="form-control" type="text" name="bankname" value="<?php echo $edit_staffs['bankname']; ?>" placeholder="Bank name">
                            </div>
                          </div>
                        </div>
                      <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">
                          <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="insta" value="<?php echo $edit_staffs['insta']; ?>" placeholder="Instagram">
                            </div>
                            <div class="form-group">
                               <h3>Whatsapp Link</h3>
                              <input class="form-control" type="text" name="whatts" value="<?php echo $edit_staffs['whatts']; ?>" placeholder="Whatsapp">
                            </div>
                            <div class="form-group">
                              <h3>Email</h3>
                              <input class="form-control" type="text" name="email" value="<?php echo $edit_staffs['email']; ?>"  placeholder="Email">
                            </div>

                            <div class="form-group">
                              <h3>Designation</h3>
                              <input class="form-control" type="text" name="designation" value="<?php echo $edit_staffs['designation']; ?>" placeholder="Designation">
                            </div>

                            <div class="form-group">
                              <h3>Account Number</h3>
                              <input class="form-control" type="text" name="account" value="<?php echo $edit_staffs['account']; ?>" placeholder="Account Number">
                            </div>
                        </div>
                      </div> 
                      ...
                      <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">
                          <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success" href='<?php echo $edit_staffs['id']; ?>'></a>Update</button>
