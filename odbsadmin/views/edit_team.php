                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <h3>Firstname</h3>
                            <input class="form-control" type="text" name="firstname" value="<?php echo $edit_teams['firstname']; ?>" placeholder="Firstname">
                          </div>

                            <div class="form-group">
                              <h3>Othername</h3>
                              <input class="form-control" type="text" name="othername" value="<?php echo $edit_teams['othername']; ?>" placeholder="Othername">
                            </div>

                            <div class="form-group">
                              <h3>Facebook Link</h3>
                              <input class="form-control" type="text" name="face" value="<?php echo $edit_teams['face']; ?>" placeholder="Facebook">
                            </div>

                            <div class="form-group">
                               <h3>Tweeter Link</h3>
                              <input class="form-control" type="text" name="tweet" value="<?php echo $edit_teams['tweet']; ?>" placeholder="Tweeter">
                            </div>
                          </div>
                        </div>
                      <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">
                          <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="insta" value="<?php echo $edit_teams['insta']; ?>" placeholder="Instagram">
                            </div>
                            <div class="form-group">
                               <h3>Whatsapp Link</h3>
                              <input class="form-control" type="text" name="whatts" value="<?php echo $edit_teams['whatts']; ?>" placeholder="Whatsapp">
                            </div>
                            <div class="form-group">
                              <h3>Email</h3>
                              <input class="form-control" type="text" name="email" value="<?php echo $edit_teams['email']; ?>" placeholder="Email">
                            </div>

                            <div class="form-group">
                              <h3>Designation</h3>
                              <input class="form-control" type="text" name="designation" value="<?php echo $edit_teams['designation']; ?>" placeholder="Designation">
                            </div>
                            
                            <div class="form-group">
                              <input type="file" name="fileToUpload">
                            </div>
                            <button name='edit_post' type='submit' class=" btn btn-success' href='<?php echo $edit_teams['id']; ?>
                         ">Update</a></button>
