                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="topic" value="<?php echo $view_press['topic']; ?>" placeholder="Topic">
                          </div>

                            <div class="form-group">
                              <h2>Admin</h2>
                              <input class="form-control" type="text" name="admin" value="<?php echo $view_press['admin']; ?>" placeholder="Admin">
                            </div>

                           <div class="form-group">
                            <h2>Message</h2>
                            <textarea class="form-control" name="message" placeholder="write.."><?php echo $view_press['message']; ?></textarea>
                          </div>
                          <div class="form-group">
                            <button type="submit" class="btn btn-success" href='<?php echo $view_press['id']; ?>'></a>Update</button>
                          </div>  
                        </div>
                      </div>
