      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <?php if (count($post_events_tables) > 0): ?>
            <?php foreach ($post_events_tables as $post_events_table): $id = $post_events_table['id']; $images = $post_events_table['images']; $date = date('d-m-Y'); ?>
                  <!-- Info Column -->
                    <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          <div class="form-group">
                            <textarea class="form-control" name="message" placeholder="write.."><?php echo $post_events_table['message']; ?></textarea>
                          </div>
                           <div class="form-group">
                            <input class="form-control" type="text" name="topic" value="<?php echo $post_events_table['topic']; ?>" placeholder="Topic">
                          </div>
                          <div class="form-group">
                            <h5>EVENT IMAGES HERE</h5>
                      ...
                      <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                        <div class="innercolumn">
                          <div class="form-group">
                            ...
                            <?php echo "<td><a href='edit_event?id={$id}'>EDIT EVENT</a></td>"; ?><br>
                            <?php echo "<td><a href='view_event?id={$id}'>VIEW EVENT</a>"; ?><br>
                            <?php echo "<td><a href='delete_event?id={$id}'>DELETE EVENT</a><td>"; ?><br>
                            <span>Date:</span>  <td><?php echo $date ?></td><br>

                            <a href="event_tables" class="btn btn-primary" type="submit">Back To Dashboard</a>
