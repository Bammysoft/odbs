      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <?php if (count($trainingcourse_tables) > 0): ?>
                 <?php foreach ($trainingcourse_tables as $trainingcourse_table): $id = $trainingcourse_table['id']; $date = date('d-m-Y'); ?>
                ...
                <div class="row clearfix">
                  ...
                  <!-- Info Column -->
                    ...
                    <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          <div class="form-group">
                            <h3>Course Title</h3>
                            <input class="form-control" type="text" name="course_title" value="<?php echo $trainingcourse_table['course_title']; ?>" placeholder="Course Title">
                          </div>
                          <div class="form-group">
                            <h3>Course Description</h3>
                            <textarea class="form-control" name="message" value="" placeholder="Description.."><?php echo $trainingcourse_table['message']; ?></textarea>
                          </div>
                      ...
                      <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                        <?php  echo "<td><a href='edit_training?id={$id}'>Edit Team</a></td>"; ?><br>
                        <?php  echo "<td><a href='view_training?id={$id}'>View Team</a></td>"; ?><br>
                        <?php  echo "<td><a href='delete_training?id={$id}'>Delete Team</a></td>"; ?><br>
