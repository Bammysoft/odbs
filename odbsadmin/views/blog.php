                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="topic" value="" placeholder="Topic">
                          </div>

                            <div class="form-group">
                              <h2>Admin</h2>
                              <input class="form-control" type="text" name="admin" value="" placeholder="Admin">
                            </div>

                           <div class="form-group">
                            <h2>Message</h2>
                            <textarea class="form-control" name="message" placeholder="write.."><?php //echo $edit_teams['message']; ?></textarea>
                          </div>
                            <div class="form-group">
                              <h2>Image</h2>
