                      ...
                      <div class="contactform">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                               <h3>question 1</h3>
                              <input class="form-control" type="text" name="question1" placeholder="question 1">
                            </div>
                              <div class="form-group">
                              <h3>question 2</h3>
                              <input class="form-control" type="text" name="question2"  placeholder="question 2">
                            </div>
                            <div class="form-group">
                              <h3>question 3</h3>
                              <input class="form-control" type="text" name="question3"  placeholder="question 3">
                            </div>
                             <div class="form-group">
                              <h3>question 4</h3>
                              <input class="form-control" type="text" name="question4"  placeholder="question 4">
                            </div>
                            <div class="form-group">
                              <h3>question 5</h3>
                              <input class="form-control" type="text" name="question5"  placeholder="question 3">
                            </div>
                          </div>
                        </div>
                      <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">  
                            <div class="form-group">
                              <h3>question 6</h3>
                              <input class="form-control" type="text" name="question6"  placeholder="question 6">
                            </div>

                            <div class="form-group">
                              <h3>question 7</h3>
                              <input class="form-control" type="text" name="question7"  placeholder="question 7">
                            </div>

                            <div class="form-group">
                              <h3>question 8</h3>
                              <input class="form-control" type="text" name="question8"  placeholder="question 8">
                            </div>

                             <div class="form-group">
                              <h3>question 9</h3>
                              <input class="form-control" type="text" name="question9"  placeholder="question 9">
                            </div>
                            <div class="form-group">
                              <h3>question 10</h3>
                              <input class="form-control" type="text" name="question10"  placeholder="question 10">
                            </div>
                            <div class="form-group">
                            <h3>Answer to question 1</h3>
                            <input class="form-control" type="text" name="answerquestion1" placeholder=" Answer to question 1">
                          </div>
                          <div class="form-group">
                            <h3>Answer to question 2</h3>
                            <input class="form-control" type="text" name="answerquestion2"  placeholder=" Answer to question 2">
                          </div>
                            <div class="form-group">
                            <h3>Answer to question 3</h3>
                            <input class="form-control" type="text" name="answerquestion3" placeholder=" Answer to question 3">
                          </div>
                        </div>
                      </div> 
                      ...
                      <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="answerquestion4"  placeholder=" Answer to question 4">
                          </div>
                          <div class="form-group">
                            <h3>Answer to question 5</h3>
                            <input class="form-control" type="text" name="answerquestion5"  placeholder=" Answer to question 5">
                          </div>
                         <div class="form-group">
                            <h3>Answer to question 6</h3>
                            <input class="form-control" type="text" name="answerquestion6"  placeholder=" Answer to question 6">
                          </div>

                          <div class="form-group">
                            <h3>Answer to question 7</h3>
                            <input class="form-control" type="text" name="answerquestion7"  placeholder=" Answer to question 7">
                          </div>
                           <div class="form-group">
                            <h3>Answer to question 8</h3>
                            <input class="form-control" type="text" name="answerquestion8"  placeholder=" Answer to question 8">
                          </div>
                           <div class="form-group">
                            <h3>Answer to question 9</h3>
                            <input class="form-control" type="text" name="answerquestion9"  placeholder=" Answer to question 9">
                          </div>
                           <div class="form-group">
                            <h3>Answer to question 10</h3>
                            <input class="form-control" type="text" name="answerquestion10"  placeholder=" Answer toquestion 10">
                          </div> 
                           <div class="form-group">
