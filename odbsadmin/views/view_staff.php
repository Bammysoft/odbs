                    ...
                    <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                      ...
                      <div class="contactform">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <h3>Firstname</h3>
                            <input class="form-control" type="text" name="firstname" value="<?php echo $view_staffs['firstname']; ?>" placeholder="Firstname">
                          </div>

                            <div class="form-group">
                              <h3>Othername</h3>
                              <input class="form-control" type="text" name="othername" value="<?php echo $view_staffs['othername']; ?>" placeholder="Othername">
                            </div>

                            <div class="form-group">
                              <h3>Facebook Link</h3>
                              <input class="form-control" type="text" name="face" value="<?php echo $view_staffs['face']; ?>"  placeholder="Facebook">
                            </div>

                            <div class="form-group">
                               <h3>Tweeter Link</h3>
                              <input class="form-control" type="text" name="tweet" value="<?php echo $view_staffs['tweet']; ?>" placeholder="Tweeter">
                            </div>
                            <div class="form-group">
                              <h3>Bank Name</h3>
                              <input class="form-control" type="text" name="bankname" value="<?php echo $view_staffs['bankname']; ?>" placeholder="Bank name">
                            </div>
                          </div>
                        </div>
                      <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">
                          <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="insta" value="<?php echo $view_staffs['insta']; ?>" placeholder="Instagram">
                            </div>
                            <div class="form-group">
                               <h3>Whatsapp Link</h3>
                              <input class="form-control" type="text" name="whatts" value="<?php echo $view_staffs['whatts']; ?>" placeholder="Whatsapp">
                            </div>
                            <div class="form-group">
                              <h3>Email</h3>
                              <input class="form-control" type="text" name="email" value="<?php echo $view_staffs['email']; ?>"  placeholder="Email">
                            </div>

                            <div class="form-group">
                              <h3>Designation</h3>
                              <input class="form-control" type="text" name="designation" value="<?php echo $view_staffs['designation']; ?>" placeholder="Designation">
                            </div>

                            <div class="form-group">
                              <h3>Account Number</h3>
                              <input class="form-control" type="text" name="account" value="<?php echo $view_staffs['account']; ?>" placeholder="Account Number">
                            </div>
                        </div>
                      </div> 
                      ...
                      <div class="info-column col-lg-4  col-md-6 col-md-12 col-sm-12">
                        <div class="contactform">
                          <div class="form-group">
                            ...
                            <a href="<?php echo HOME; ?>staff_tables" class="btn btn-primary" type="submit">Back To Dashboard</a>
                        </div>
                      </div> 
                      </div>
                    </form>
