                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <textarea class="form-control" name="message" placeholder="write.."><?php echo $view_events['message']; ?></textarea>
                          </div>
                          <div class="form-group">
                            <input class="form-control" type="text" name="topic" value="<?php echo $view_events['topic']; ?>" placeholder="Topic">
                          </div>
                         <!--  -->
