        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dmataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>First Name</th>
                    <th>Othername</th>
                ...
                <tbody>
                  ...
                  foreach ($students as $student) {
                    ...
                    echo"<th>$message</th>";
                    echo"<th>$date</th>";
                    echo " <td><a href='delete_student?id={$id}'>Delete</a></td>";
                     echo "<td><img class = 'img-responsonsive' style='width: 100px; height: 100px;' src='../".$images."' alt='images'></td>"; 
                    echo "<td><a href='updatecertificate?id={$id}'>Upload Certificate</a></td>"; 
