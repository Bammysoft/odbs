    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><h2>POST CERTIFICATE(S)</h2></li>
        </ol>
                    ...
                    <div class="info-column col-lg-6  col-md-6 col-md-12 col-sm-12">
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <h5>POST EVENT CERTFICATE HERE</h5>
                            <input type="file" name="fileToUpload">
                          </div>
                            <button type="submit" class="btn btn-success">Post Certificate</button>
                        </div>
                      </div>
