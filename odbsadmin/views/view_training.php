                      ...
                      <div class="contactform">
                        <form method="post" action="" enctype="multipart/form-data">
                          <div class="form-group">
                            <h3>Course Title</h3>
                            <input class="form-control" type="text" name="course_title" value="<?php echo $view_trainings['course_title']; ?>" placeholder="Course Title">
                          </div>
                          <div class="form-group">
                            <h3>Course Description</h3>
                            <textarea class="form-control" name="message" value="" placeholder="Description.."><?php echo $view_trainings['message']; ?></textarea>
                          </div>
                         <button name='edit_post' type='submit' class=" btn btn-success' href='<?php echo $view_trainings['id']; ?>
                         ">Update</a></button>
                          <a href="<?php echo HOME; ?>training_tables" type="submit" class="btn btn-success">Continue</a>
